...
class CustomImageDataset(Dataset):
    ...
    Args:
        annotation_file: percorso del file csv che contiene le annotazioni delle immagini.
        Ogni riga nel file csv contiene il nome del file dell'immagine e la sua etichetta.
        image_dir: directory in cui sono salvate le immagini
        transform: opzionale. Funzione di trasformazione da applicare a ciascuna immagine, ad esempio
        normalizzazione, ridimensionamento, etc.
        target_transform: opzionale. Funzione di trasformazione da applicare alle etichette. Ad esempio,
